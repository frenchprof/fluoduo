...
def main() -> int:
    ...
    bad: list[str] = []
    if not src:
        print("verify84: src/content/memos.tsx is missing")
        return 1
    ...
    if bad:
        print("verify84 — the atelier English toggle:")
        for b in bad:
            print(f"  ✗ {b}")
        return 1
    print("verify84: the atelier model's English is on by default, switchable, and remembered.")
    return 0
