...
/** 🗺️ La Carte — a DEDICATED MAP INTERFACE, not an embedded page (Dan,
...
export default function CartePage() {
  return (
    <main className="carte-full min-h-screen" style={{ background: "var(--cahier-paper)", color: "var(--cahier-ink)" }}>
      <div
