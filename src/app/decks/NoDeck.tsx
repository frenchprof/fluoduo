...
export default function NoDeck() {
  return (
    <CahierShell tabs={[{ key: "home", label: "Home", emoji: "🏠", href: "/" }, { key: "index", label: "Index", emoji: "📚", href: "/activities" }]} active="index">
      <div className="mx-auto max-w-md px-4 py-10 text-center">
        <div className="rounded-2xl border-2 p-8" style={{ borderColor: "var(--cahier-line)", background: "var(--cahier-paper-raised)" }}>
          ...
          <Link href="/activities" className="fluo-btn mt-5 inline-flex">📚 Open the Index</Link>
        </div>
      </div>
    </CahierShell>
  );
