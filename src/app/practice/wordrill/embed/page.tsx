...
/**
 * /practice/wordrill/embed — WorDrill, running inside the cahier rather than drawing one.
 *
 ...
 * surfaces"*. `/practice/wordrill` is the page a learner opens; this is what runs in the
