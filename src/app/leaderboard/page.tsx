  ...
  return (
    <CahierShell tabs={tabsWithActive(siteTabs(), "home")} active="leaderboard" crumb="🏆 Classement">
      <div className="mx-auto max-w-xl px-3 py-5">
        <h1 className="cahier-display text-2xl font-black text-[color:var(--cahier-ink)]">🏆 Le Classement <span className="text-lg font-bold text-[color:var(--cahier-ink-soft)]">· Leaderboard</span></h1>
