...
export default function GuideSplash({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[85] bg-black/35 p-4 backdrop-blur-[2px]" role="dialog" aria-modal="true" aria-label="HELP!" onClick={close}>
      <div
      ...
      >
        <h2 className="cahier-display text-xl font-black text-[color:var(--cahier-ink)]">❓ HELP!</h2>
