    ...
    >
      ...
      >
        <div className="mb-3 flex items-center justify-between">
          <h2 className="cahier-display text-lg font-black text-[color:var(--cahier-ink)]">🏆 Leaderboard</h2>
          <div className="flex items-center gap-2">
            <Link href="/leaderboard" onClick={onClose} className="text-xs font-bold underline">full page</Link>
            <button type="button" onClick={onClose} aria-label="Close" className="cahier-btn cahier-btn-sm">✕</button>
          </div>
        </div>
