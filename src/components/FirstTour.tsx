...
function tourFor(rawPath: string): Tour | null {
  ...
  if (path === "/" || path === "") {
    return {
      key: "home",
      steps: [
        { selector: "nav.cahier-tabs, .cahier-menu > button", action: "tap", text: "Tap a flap: the five Units on top; below, ❓ HELP!, 📖 Index and the tools. They follow you everywhere." },
