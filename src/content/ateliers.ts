...
export const ATELIER_DIALOGUES: Record<string, DialogueLine[]> = {
  ...
  "SIO-030": [
    ...
    { who: "A", fr: "C'est ton anniversaire samedi : bon anniversaire !", en: "It's your birthday on Saturday — happy birthday!" },
    { who: "A", fr: "Bonne chance pour ton examen !", en: "Good luck with your exam!" },
    { who: "A", fr: "Tu vas à Paris avec ta famille ? Bon voyage !", en: "You're going to Paris with your family? Have a good trip!" },
