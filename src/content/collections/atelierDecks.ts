...
const ATELIER_META: Record<string, { title: string; subtitle: string; unit: number; lessonNo: number; slug: string; seq: number }> = {
  ...
  "SIO-049": { title: "Atelier — Au restaurant", subtitle: "the restaurant scene, line by line", unit: 4, lessonNo: 9, slug: "atelier-resto", seq: 449 },
  "SIO-050": { title: "Atelier — Avis de restaurant", subtitle: "the restaurant review, line by line", unit: 4, lessonNo: 10, slug: "atelier-avis-resto", seq: 450 },
};
