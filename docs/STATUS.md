...
| 10 | **Still needing Dan's pedagogical call:** daily-goal size, variable reward, the streak freeze, the gem locker. Receipt not yet wired into the other drills. | 2 | Dan, then agent |
