...
| 11 | **How far to spread the family bands** — Dan's call. Hubs only, or drills too? A drill is a focus surface and five colours may hurt it. Also still open: daily-goal size, variable reward, streak freeze, gem locker; receipt beyond iComplete. | 3 | **Dan, then agent** |
