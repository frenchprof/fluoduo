...
| **Pre-tests** | **Pre-test surfaces** | ✅ Unit-0 pages (#98) · ✅ popup collapse (#99) · ✅ derived done-ness (#104, open) · ✅ iComplete cut + SIO-010 tabs (#106, open) · **next: Tier-1 concept batches as second capacity** |
...
- **Pre-tests — the pre-test surface, then capacity.** ~~Unit-0 pre-test pages
  ...
  **The popup collapse and derived done-ness** — two instructions Dan gave on
  ...
  3. ✅ **DONE — #106. iComplete's orphan route cut; SIO-010 sits all three
