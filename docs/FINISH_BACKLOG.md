...
| **Politesse → SIO-009** | Politesse **folds into Greetings (SIO-009)**. Not a separate stop. Pack sits with *Bonjour / Salut / Au revoir* + register. SIO-010 stays the name + *Enchanté(e)* chain. Shops / restaurant later **reuse** these chips; they do not reteach them. Lands as item **9b**, after #156. |
...
| **9b** | **Politesse → Greetings (SIO-009)** | Not a separate stop. Folds into the SIO-009 Greetings Flip It / SpecuLearn pack, beside *Bonjour / Salut / Au revoir* + register. SIO-010 stays name + *Enchanté(e)* only. Later shop / restaurant stops reuse the chips. | Content PR **after #156** is on `main` (still inside the 1–9 beat). Add to the SIO-009 pack: *Je voudrais…, s’il vous plaît* · *Excusez-moi* · *Pardon* · *Merci / De rien* · *désolé(e)* · *Je vous en prie*. *désolé(e)* gender-agrees with the SIO-010 role cue when gender matters (`Léa · she` / `Marc · he`). FR QA accents + gender on *désolé / désolée*. No new SIO id. No Continue node. | **No separate politesse stop** on the map or Continue spine. SIO-009 pack includes the full list. *désolé(e)* shows the role cue when gender is the point. Unit Continue spine **unchanged** (still 001–050). Shops / restaurant do not invent a second politesse deck. | FR + Pedagogy → Claude(impl) |
